...
# Clear P3009 failed marker when completed_hours backfill failed (e.g. work_sessions missing).
prisma migrate resolve --rolled-back 20260626140000_add_service_exchange_completed_hours 2>/dev/null || true
